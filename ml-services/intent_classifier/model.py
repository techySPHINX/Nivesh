...
class IntentClassifier:
    ...
    def __init__(
        ...
        logger.info(f"Initialized IntentClassifier with {self.num_labels} labels")
    ...
    def prepare_data(
        ...
        logger.info(f"Data split: Train={len(train_queries)}, Val={len(val_queries)}, Test={len(test_queries)}")
    ...
    def predict(self, query: str) -> Dict[str, Any]:
        ...
        # Get top predictions
        top_probs, top_indices = torch.topk(probs, k=min(3, self.num_labels), dim=-1)

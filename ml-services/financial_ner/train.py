...
def train_financial_ner(
    ...
    with mlflow.start_run(run_name='financial_ner_training'):
        ...
        # Train
        train_metrics = ner.train(train_data, n_iter=n_iter, output_dir=output_dir)
        ...
        # Log model to MLflow
        mlflow.spacy.log_model(ner.nlp, 'model', registered_model_name='financial_ner')
...
def main():
    ...
    parser.add_argument('--output-dir', type=str, default='./models/financial_ner', help='Output directory')

...
class FinancialNER:
    ...
    def __init__(self, model_name: str = None):
        ...
        logger.info(f"Initialized FinancialNER with entity types: {self.entity_types}")
    ...
    def create_blank_model(self, lang: str = "en"):
        ...
        logger.info(f"Created blank model with {len(self.entity_types)} entity types")
    ...
    def load_model(self, model_path: str = None):
        ...
        if model_path:
            ...
            try:
                ...
                logger.warning(f"Model {self.model_name} not found, creating blank model")
    ...
    def train(
        ...
        with self.nlp.disable_pipes(*other_pipes):
            ...
            for iteration in range(n_iter):
                ...
                if iteration % 5 == 0:
                    logger.info(f"Iteration {iteration}: Loss = {losses.get('ner', 0.0):.4f}")

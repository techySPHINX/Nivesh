...
class TestInputValidator:
    ...
    def test_validate_text_valid(self):
        ...
        result = InputValidator.validate_text(
            text, min_length=3, max_length=100)
    ...
    def test_validate_numeric_valid(self):
        ...
        result = InputValidator.validate_numeric(
            42.5, "amount", min_value=0, max_value=100)
        assert result == 42.5
    ...
    def test_validate_dict_missing_fields(self):
        ...
        with pytest.raises(ValueError, match="missing required fields"):
            InputValidator.validate_dict(
                data, required_fields=["key1", "key2"])
...
class TestRateLimiter:
    ...
    def test_rate_limiter_multiple_clients(self):
        ...
        assert limiter.check_rate_limit(
            "client_2", max_requests=1, window_seconds=60)
...
class TestSecurityIntegration:
    ...
    def test_full_validation_pipeline(self):
        ...
        amount = InputValidator.validate_numeric(
            raw_input["amount"], "amount", min_value=0)

...
import { AgentType, ExecutionPlan, ExecutionStep } from "../types/agent.types";
...
export class ExecutionPlanBuilder {
  ...
  buildPlan(
    ...
    const plan: ExecutionPlan = {
      ...
      metadata: {
        name: workflow.name,
        version: "1.0",
        description: `${workflow.mode} execution plan`,
      },
    };
  ...
  private createSteps(
    ...
    return agents.map((agentType, index) => {
      const step: ExecutionStep = {
        ...
        dependencies:
          mode === "sequential" && index > 0 ? [`step-${index}`] : [],
  ...
  validatePlan(plan: ExecutionPlan): { valid: boolean; errors: string[] } {
    ...
    for (const step of plan.steps) {
      for (const dep of step.dependencies) {
        if (!stepIds.has(dep)) {
          errors.push(`Step ${step.stepId} has invalid dependency: ${dep}`);
        }
      }
    }
  ...
  private initializeWorkflows(): void {
    ...
    this.workflows.set("goal_planning", {
      name: "Goal Planning",
      description:
        "Comprehensive financial goal planning with savings plan, risk assessment, and investment strategy",
      agents: [
    ...
    this.workflows.set("portfolio_review", {
      ...
      description:
        "Multi-faceted portfolio analysis including risk, allocation, and transaction patterns",
      agents: [
        AgentType.RISK_ASSESSMENT,
        AgentType.INVESTMENT_ADVISOR,
    ...
    this.workflows.set("risk_assessment", {
      ...
      description:
        "Comprehensive risk analysis with spending pattern insights and mitigation actions",
      agents: [
        AgentType.RISK_ASSESSMENT,
        AgentType.FINANCIAL_GRAPH,
        AgentType.ACTION_EXECUTION,
    ...
    this.workflows.set("budget_analysis", {
      ...
      description:
        "Spending pattern analysis with budget monitoring and actionable recommendations",
      agents: [
        AgentType.FINANCIAL_GRAPH,
    ...
    this.workflows.set("loan_affordability", {
      ...
      description:
        "Loan affordability check with stress testing and risk assessment",
      agents: [
        AgentType.SIMULATION,
        AgentType.RISK_ASSESSMENT,
        AgentType.ACTION_EXECUTION,
    ...
    this.workflows.set("retirement_planning", {
      ...
      description:
        "Retirement corpus calculation with investment strategy and timeline",
      agents: [
        AgentType.FINANCIAL_PLANNING,
        AgentType.SIMULATION,
        AgentType.INVESTMENT_ADVISOR,
    ...
    this.workflows.set("tax_optimization", {
      ...
      description:
        "Tax-saving investment recommendations with product suggestions",
      agents: [
        AgentType.INVESTMENT_ADVISOR,
        AgentType.FINANCIAL_GRAPH,
        AgentType.ACTION_EXECUTION,
    ...
    this.workflows.set("comprehensive_analysis", {
      ...
      description:
        "Full financial health check covering all aspects: planning, risk, investments, monitoring",
      agents: [
        AgentType.FINANCIAL_PLANNING,
        AgentType.RISK_ASSESSMENT,
        AgentType.INVESTMENT_ADVISOR,

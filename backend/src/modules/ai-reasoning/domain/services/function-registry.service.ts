...
export class FunctionRegistry {
  ...
  private queryFinancialGraphFunction(): FunctionDeclaration {
    return {
      ...
      description:
        "Query user's financial data from Neo4j knowledge graph to get insights about spending patterns, income stability, goal progress, or account information",
      parameters: {
        type: "object" as any,
        properties: {
          query_type: {
          ...
          filters: {
            ...
            properties: {
              date_range: {
                type: "string",
                description:
                  'Date range for the query (e.g., "last_30_days", "last_6_months")',
              },
              category: {
                type: "string",
                description:
                  'Transaction category to filter by (e.g., "FOOD", "TRANSPORT")',
              },
            },
          },
        },
  ...
  private runMonteCarloSimulationFunction(): FunctionDeclaration {
    return {
      ...
      description:
        "Run Monte Carlo simulation for financial scenarios (investment returns, loan affordability, goal achievement probability)",
      parameters: {
        type: "object" as any,
        properties: {
          scenario: {
  ...
  private assessLoanAffordabilityFunction(): FunctionDeclaration {
    return {
      ...
      description:
        "Assess loan affordability based on income and existing obligations",
      parameters: {
        type: "object" as any,
        properties: {
          monthly_income: {
  ...
  private optimizePortfolioFunction(): FunctionDeclaration {
    return {
      ...
      description:
        "Optimize investment portfolio based on risk profile and goals",
      parameters: {
        type: "object" as any,
        properties: {
          risk_profile: {

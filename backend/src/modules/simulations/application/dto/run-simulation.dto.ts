...
export class RunSimulationDto {
  @ApiProperty({ description: 'Simulation name', example: 'Retirement Planning 2050' })
  @IsString()
  name: string;
  ...
  @ApiProperty({ description: 'Expected annual return rate (decimal)', example: 0.12 })
  @IsNumber()
  @Min(0)
  @Max(1)
  ...
  @ApiPropertyOptional({ description: 'Annual inflation rate (decimal)', example: 0.06 })
  @IsNumber()
  @IsOptional()
  @Min(0)
  @Max(0.5)
  ...
  @ApiPropertyOptional({ description: 'Number of Monte Carlo iterations', example: 1000 })
  @IsNumber()
  @IsOptional()
  @Min(100)
  @Max(10000)

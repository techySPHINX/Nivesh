...
export class GetSpendingPatternsHandler implements IQueryHandler<GetSpendingPatternsQuery> {
...
export class GetCategoryInsightsHandler implements IQueryHandler<GetCategoryInsightsQuery> {
...
export class GetMerchantRecommendationsHandler implements IQueryHandler<GetMerchantRecommendationsQuery> {
  ...
  async execute(query: GetMerchantRecommendationsQuery): Promise<any[]> {
    this.logger.log(
      `Getting merchant recommendations for user: ${query.userId}`,
    );
...
export class GetSimilarUsersHandler implements IQueryHandler<GetSimilarUsersQuery> {

...
export class AnalyticsController {
  ...
  @ApiOperation({
    summary: "Get spending trends over time with configurable granularity",
  })
  @ApiQuery({
    name: "from",
    required: false,
  ...
  @ApiResponse({
    ...
    type: SpendingTrendsResponseDto,
  })
  ...
  @ApiOperation({
    summary: "Get spending breakdown by category with trend analysis",
  })
  @ApiQuery({
    name: "from",
    required: false,
  ...
  async getCategoryBreakdown(
    ...
    return this.queryBus.execute(
      new GetCategoryBreakdownQuery(userId, from, to),
    );
  }
  ...
  @ApiResponse({
    ...
    type: NetWorthHistoryResponseDto,
  })
